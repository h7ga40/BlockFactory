...
namespace Blockly
{
	public class Lists
	{
		 ...
		 */
		public const int HUE = 260;
	}

	public class ListsCreateEmptyBlock : BlockSvg
	{
		public const string type_name = "lists_create_empty";

		public ListsCreateEmptyBlock(Workspace workspace)
	...
	public class ListsCreateWithBlock : BlockSvg
	{
		public const string type_name = "lists_create_with";
		internal int itemCount_;

		public ListsCreateWithBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
		...
		public override void domToMutation(Element xmlElement)
		{
			...
			this.itemCount_ = times == null ? 0 : Int32.Parse(times);
			this.updateShape_();
		}
		...
		{
			var containerBlock = (BlockSvg)workspace.newBlock(ListsCreateWithContainerBlock.type_name);
			containerBlock.initSvg();
			var connection = containerBlock.getInput("STACK").connection;
			for (var i = 0; i < this.itemCount_; i++) {
				var itemBlock = (BlockSvg)workspace.newBlock(ListsCreateWithItemBlock.type_name);
				itemBlock.initSvg();
	...
	public class ListsCreateWithContainerBlock : BlockSvg
	{
		public const string type_name = "lists_create_with_container";

		public ListsCreateWithContainerBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsCreateWithItemBlock : BlockSvg
	{
		public const string type_name = "lists_create_with_item";
		public Connection valueConnection_;

		public ListsCreateWithItemBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsRepeatBlock : BlockSvg
	{
		public const string type_name = "lists_repeat";

		public ListsRepeatBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsLengthBlock : BlockSvg
	{
		public const string type_name = "lists_length";

		public ListsLengthBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsIsEmptyBlock : BlockSvg
	{
		public const string type_name = "lists_isEmpty";

		public ListsIsEmptyBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsIndexOfBlock : BlockSvg
	{
		public const string type_name = "lists_indexOf";

		public ListsIndexOfBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
		...
		public override void init()
		{
			var OPERATORS = new JsArray<DropdownItemInfo> {
				new DropdownItemInfo(Msg.LISTS_INDEX_OF_FIRST, "FIRST"),
				new DropdownItemInfo(Msg.LISTS_INDEX_OF_LAST, "LAST")
			};
	...
	public class ListsGetIndexBlock : BlockSvg
	{
		public const string type_name = "lists_getIndex";
		JsArray<DropdownItemInfo> WHERE_OPTIONS;

		public ListsGetIndexBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsSetIndexBlock : BlockSvg
	{
		public const string type_name = "lists_setIndex";
		JsArray<DropdownItemInfo> WHERE_OPTIONS;

		public ListsSetIndexBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
	...
	public class ListsGetSublistBlock : BlockSvg
	{
		public const string type_name = "lists_getSublist";

		public JsArray<DropdownItemInfo>[] WHERE_OPTIONS;

		public ListsGetSublistBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
		...
		public override void init()
		{
			WHERE_OPTIONS = new[] {
				new JsArray<DropdownItemInfo> {
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_START_FROM_START, "FROM_START"),
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_START_FROM_END, "FROM_END"),
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_START_FIRST, "FIRST")
				},
				new JsArray<DropdownItemInfo> {
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_END_FROM_START, "FROM_START"),
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_END_FROM_END, "FROM_END"),
					new DropdownItemInfo(Msg.LISTS_GET_SUBLIST_END_LAST, "LAST")
				}
			};
	...
	public class ListsSortBlock : BlockSvg
	{
		public const string type_name = "lists_sort";

		public ListsSortBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
				...
				{ "args0", new object[] {
					new Dictionary<string, object> {
						...
						{ "options", new JsArray<DropdownItemInfo> {
							new DropdownItemInfo (Msg.LISTS_SORT_TYPE_NUMERIC, "NUMERIC"),
							new DropdownItemInfo (Msg.LISTS_SORT_TYPE_TEXT, "TEXT"),
							new DropdownItemInfo (Msg.LISTS_SORT_TYPE_IGNORECASE, "IGNORE_CASE")
						} }
					},
					new Dictionary<string, object> {
						{ "type", "field_dropdown" },
						{ "name", "DIRECTION" },
						{ "options", new JsArray<DropdownItemInfo> {
							new DropdownItemInfo (Msg.LISTS_SORT_ORDER_ASCENDING, "1"),
							new DropdownItemInfo (Msg.LISTS_SORT_ORDER_DESCENDING, "-1")
						} }
					},
					new Dictionary<string, object> {
						{ "type", "input_value" },
	...
	public class ListsSplitBlock : BlockSvg
	{
		public const string type_name = "lists_split";

		public ListsSplitBlock(Workspace workspace)
			: base(workspace, type_name)
		{
		}
