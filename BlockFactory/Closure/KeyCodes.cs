...
namespace goog
{
	public static partial class events
	{
		...
		public static bool KeyCodes_isCharacterKey(KeyCodes keyCode)
		{
		...
		private static KeyCodes KeyCodes_normalizeKeyCode(KeyCodes keyCode)
		{
			if (goog.userAgent.GECKO) {
				return goog.events.KeyCodes_normalizeGeckoKeyCode(keyCode);
			}
			else if (goog.userAgent.MAC && goog.userAgent.WEBKIT) {
				return goog.events.KeyCodes_normalizeMacWebKitKeyCode(keyCode);
			}
			else {
				return keyCode;
			}
		...
		public static KeyCodes KeyCodes_normalizeGeckoKeyCode(KeyCodes keyCode)
		{
			switch (keyCode) {
			case goog.events.KeyCodes.FF_EQUALS:
