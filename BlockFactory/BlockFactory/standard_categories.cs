...
namespace BlockFactoryApp
{
	...
	public static class StandardCategories
	{
		...
		// to the toolbox.
		public static Dictionary<string, ListElement> categoryMap = new Dictionary<string, ListElement>();

		static StandardCategories()
		{
			var le = new ListElement(ListElement.TYPE_CATEGORY, "Logic");
			StandardCategories.categoryMap["logic"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Loops");
			StandardCategories.categoryMap["loops"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Math");
			StandardCategories.categoryMap["math"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Text");
			StandardCategories.categoryMap["text"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Lists");
			StandardCategories.categoryMap["lists"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Colour");
			StandardCategories.categoryMap["colour"] = le;
			le.xml = Blockly.Xml.textToDom(
				"<xml>" +
			...
			le = new ListElement(ListElement.TYPE_CATEGORY, "Functions");
			StandardCategories.categoryMap["functions"] = le;
			le.color = "#9A5CA6";
			le.custom = "PROCEDURE";

			le = new ListElement(ListElement.TYPE_CATEGORY, "Variables");
			StandardCategories.categoryMap["variables"] = le;
			le.color = "#A65C81";
			le.custom = "VARIABLE";
		}

		// All standard block types in provided in Blockly core.
		public static string[] coreBlockTypes = new[]{"controls_if", "logic_compare",
